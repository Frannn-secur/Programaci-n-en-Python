...
dos condiciones que serian si 'b' es != 0 o == 0 en este caso al ser diferente de 0 nos da como salida --> La ecucación
no tiene solución

3) En el tercer caso se produce lo mismo que en el apartado dos puesto que 'a' es == 0 y 'b' es != de 0 por lo que nos
...
esta tenemos otras dos condiciones que serian si 'b' es != 0 o == 0 en este caso al ser 'b' == 0 se saltaría la línea de
